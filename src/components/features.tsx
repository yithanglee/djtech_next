      ...
      <div className="container mx-auto bg-white" style={{ padding: '4vh 0' }}>
        ...
        <div className="flex flex-col gap-4 items-center">
          <div className="grid grid-cols-12 lg:grid-cols-6">
            <Image src="/images/qr-sticker-step.png" alt="QR Code" width={500} height={300} className="col-span-6 mx-auto " />
          ...
          <div className="grid grid-cols-12 lg:grid-cols-6">
            <Image src="/images/scan-pay-step.png" alt="QR Code" width={500} height={300} className="col-span-6 mx-auto w-full" />
            <div className="flex justify-between items-center col-span-6 gap-4 mx-auto">
              <div className="text-center">
